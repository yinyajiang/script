...
{
    echo "  - enableFfprobe"
    FFMPEG_ENABLE="${FFMPEG_ENABLE} --enable-ffprobe"
}

disableFfprobe()
{
    echo "  - disableFfprobe"
    FFMPEG_ENABLE="${FFMPEG_ENABLE} --disable-ffprobe"
}

disableDebug()
{
    echo "  - disableDebug"
    FFMPEG_ENABLE="${FFMPEG_ENABLE} --disable-debug"
}

disableSdl2()
{
    echo "  - disableSdl2"
    FFMPEG_ENABLE="${FFMPEG_ENABLE} --disable-sdl2"
}

disableOutdevs()
{
    echo "  - disableOutdevs"
    FFMPEG_ENABLE="${FFMPEG_ENABLE} --disable-outdevs"
}

disableAutodetect()
{
    echo "  - disableAutodetect"
    FFMPEG_ENABLE="${FFMPEG_ENABLE} --disable-autodetect"
}
